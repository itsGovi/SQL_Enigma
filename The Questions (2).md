...
1. Identify employees hired in the last 30 days and calculate their average engagement_score.
...
10. Display all employees in the APAC region with avg_project_duration exceeding the department average.
11. Identify employees with flight_risk below 20 and span_of_control above 3.
12. Rank employees by their avg_actual_utilization within their job levels, grouped by department.
13. List employees whose knowledge_sharing_score is in the top 10% of their department.
14. Compute the percentage of employees in each specialization with more than one certification.
15. Identify departments with the smallest gaps between utilization_target and actual_utilization.
16. Display employees in the EMEA region sorted by retention_risk and delivery_quality.
17. Calculate avg_project_complexity by hire_year and compare trends across regions.
18. Find employees with direct_reports exceeding 5 and avg_project_satisfaction below 70.
19. List the top 5 primary_specializations by avg_performance_score and compare them across regions.
20. Identify employees with the highest flight_risk and their respective avg_training_hours.
